...
var multi_choice_1 = {
    ...
    questions: [
        {prompt:"<p>In the first fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\" <br/>" +
                " You are also told: \"The apples are not industrial.\"     </p>" +
...
var multi_choice_2 = {
    type: 'survey-multi-choice',
    questions: [
        {prompt:"<p>In the second fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\" <br/>You are also told:" +
...
var multi_choice_3 = {
    type: 'survey-multi-choice',
    questions: [
        {prompt:"<p>In the third fruit shop, you are told the following: <br/>\"If apples are cultivated with pesticides, they are declared industrial.\"<br/> You are also told:" +
...
var multi_choice_4 = {
    type: 'survey-multi-choice',
    questions: [
        {prompt:"<p>In the fourth fruit shop, you are told the following: <br/> \"If apples are cultivated with pesticides, they are declared industrial.\"<br/> You are also told:" +
        ...
        if(data.trial_index == 14){
            ...
            if(jsPsych.pluginAPI.compareKeys(data.response.valu, data.correct_response)) {/*Valid answer*/
                ...
                multi_choice_5.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/>\"In the first fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                    ...
                    " <p><b><u>And the explanation was:</u></b><br/> \"It says that the apples are not industrial, so they can't possibly be cultivated with pesticides : \n" +
        ...
        if(data.trial_index == 16){
            ...
            if(jsPsych.pluginAPI.compareKeys(data.response.valu, data.correct_response)) {/*Valid answer*/
                multi_choice_6.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the second fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                    ...
                    " <p><b><u>And the explanation was:</u></b><br/> \"It is stated that the apples are cultivated with pesticides. \n" +
                    " But we don't know about other things that could make it not industrial.\" <br/></p>" +
                    " <p><b>You can now re-answer this question.</b> According to you, what is the right answer? "
            } else {/* Invalid answer*/
                multi_choice_6.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the second fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                    " <br/>You are also told:" +
                    ...
                    " <p><b><u>And the explanation was:</u></b><br/> \"It is stated that the apples are cultivated with pesticides. \n" +
                    " Regardless of other factors, the rule states that if pesticides are used, then the apples are industrial. Therefore the apples are industrial." +
                    "\"<br/></p>" +
                    " <p><b>You can now re-answer this question.</b> According to you, what is the right answer? "
            }
        }
            ...
            if(data.trial_index == 20){
                ...
                if(jsPsych.pluginAPI.compareKeys(data.response.valu, data.correct_response)) {/*Valid answer*/
                    multi_choice_8.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the fourth fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                        " <br/>You are also told: " +
                        " \"The apples are industrial.\"     </p>" +
                        " <p>What can you say for sure about whether apples are organic in this shop?\"</p><p><b><u> Your answer was:</u></b><br/> \"" + data.response.valu + "\" </p> " +
                        " <p><b><u>The answer of a previous participant was:</u></b><br/> \"The apples are cultivated with pesticides\" \n" +
                        " <p><b><u>And the explanation was:</u></b><br/> \"The apples are industrial. The use of pesticides is what makes the apples industrial. Therefore pesticides were used\"" +
                        " <br/></p>" +
                        " <p><b>You can now re-answer this question.</b> According to you, what is the right answer? "
                } else {/* Invalid answer*/
                    multi_choice_8.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the fourth fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
            ...
            if(data.trial_index == 20) {
                ...
                if (jsPsych.pluginAPI.compareKeys(data.response.valu, data.correct_response)) {/*Valid answer*/
                    multi_choice_8.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the fourth fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                        " <br/>You are also told: " +
                        " \"The apples are industrial.\"     </p>" +
                        " <p>What can you say for sure about whether apples are organic in this shop?\"</p><p><b><u> Your answer was:</u></b><br/>\"The apples are cultivated with pesticides" + "\" </p> " +
                        " <p><b><u>The answer of a previous participant was:</u></b><br/> \"" + data.response.valu + "\""
                } else {/* Invalid answer*/
                    multi_choice_8.questions[0].prompt = "<p><b><u>You were asked the following question:</u></b><br/> \"In the fourth fruit shop, you are told the following:<br/> \"If apples are cultivated with pesticides, they are declared industrial.\"" +
                        " <br/>You are also told: " +
                        " \"The apples are industrial.\"     </p>" +
                        " <p>What can you say for sure about whether apples are industrial in this shop?\"</p><p><b><u> Your answer was:</u></b><br/> \"We cannot tell for sure whether apples were cultivated with pesticides\" </p> " +
                        " <p><b><u>The answer of a previous participant was:</u></b><br/>  \"" + data.response.valu + "\""
                }
            }
